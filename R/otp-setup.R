...
#' @param otp_version Numeric, version of OTP to build, default NA when version
#'   is auto-detected
#' @param
...
otp_checks <- function(otp = NULL, dir = NULL, router = NULL, graph = FALSE, otp_version = NULL) {
  # Checks
