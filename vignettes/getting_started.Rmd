...
You will need to download the latest version of the OTP from https://repo1.maven.org/maven2/org/opentripplanner/otp/ , which can be done as follows:
...
dest <- file.path(path_otp, "otp.jar")
