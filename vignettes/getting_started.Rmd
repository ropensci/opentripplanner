...
OTP requires Java 8 https://www.java.com/en/download/ . If possible the 64 Bit version of Java is preferable, especially if you want to use OTP over large areas.
...
path_otp <- "C:/otp/otp-1.3.0-shaded.jar"
