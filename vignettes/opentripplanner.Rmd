...
Then you will need to download the OTP, for more details see the [prerequisites vignette](https://itsleeds.github.io/opentripplanner/articles/prerequisites.html).
...
u <- "https://repo1.maven.org/maven2/org/opentripplanner/otp/1.4.0/otp-1.4.0-shaded.jar"
...
`router-config.json` is actually read when the OTP server is started (in the next section), but we add it now for convenience. For more information on the config files see the [advanced features vignette](https://itsleeds.github.io/opentripplanner/articles/advanced_features.html).
