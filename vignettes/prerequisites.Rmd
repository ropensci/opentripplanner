...
To use OTP on your local computer you will  need data about your location of intrest, such as where the roads are, what is the public transport timetable etc.
...
OTP can use public transport timetable data in the [GFTS format](https://developers.google.com/transit/gtfs/). You can find GTFS data for many regions at  [transitland](https://transit.land/).
