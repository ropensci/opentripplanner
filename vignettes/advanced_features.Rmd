...
As of version 0.2.3.0 the `get_elevation` argument in `otp_plan` can be set to FALSE this speeds up routing by only returning XY coordinates rather than XYZ coordinates. 
