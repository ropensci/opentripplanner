...
We can use surfaces as a more efficent way to produce a travel time matrix than using `otp_plan`. A special function `otp_traveltime` create batches of surfaces and pointsets an summarises the results as a travel time matrix.
